...
import com.secure.noteApp.security.jwt.JwtUtils;
import com.secure.noteApp.security.request.LoginRequest;
import com.secure.noteApp.security.request.SignupRequest;
...
import com.secure.noteApp.services.impl.TotpServiceImpl;
import com.secure.noteApp.util.AuthUtil;
...
//      Set the authentication
    ...
    public ResponseEntity<?> get2FAStatus(){
        ...
        if(user!=null){
            return ResponseEntity.ok().body(Map.of("is2Enabled",user.isTwoFactorEnabled()));
        } else{
